...
class StandardFormPopulationTests(TestCase):
    ...
    def setUp(self):
        ...
        for key,value in self.key_dict.items():
            data_object = ArcComments.objects.create(table_pk=value[0], table_name=key, field_name=value[1], flagged=True, comment = 'Test')
    ...
    def test_personal_details_population(self):
        ...
        key_list = [self.key_dict['APPLICANT_PERSONAL_DETAILS'][0], self.key_dict['APPLICANT_NAME'][0], self.key_dict['APPLICANT_HOME_ADDRESS'][0]]
