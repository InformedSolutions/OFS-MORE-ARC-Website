...
from ...forms.childminder_forms.form import EYFSCheckForm
from arc_application.models import Application, Arc, EYFS
...
class EFYSCheckSummaryView(View):
    ...
    def render_summary_with_context(self, request, form, app_id_local):
        ...
        return render(request, 'childminder_templates/eyfs-summary.html', context=context)
