...
from ..forms.form import ChildcareTrainingCheckForm
from ..models import Application, Arc, ChildcareTraining
...
class ChildcareTrainingCheckSummaryView(View):
    ...
    def get(self, request):
        ...
        form = ChildcareTrainingCheckForm(table_keys=[eyfs_id])
    ...
    def post(self, request):
        ...
        eyfs_id = ChildcareTraining.objects.get(application_id=application_id_local).eyfs_id
        form = ChildcareTrainingCheckForm(request.POST, table_keys=[eyfs_id])
