...
class NannyPersonalDetailsSummary(View):
    ...
    FORM_NAME = ''
    REDIRECT_LINK = reverse('nanny_childcare_address_summary')
    ...
    def get(self, request):
        ...
        personal_details = nanny_actions.read('applicant-personal-details', params={'application_id': application_id}).record
        home_address = nanny_actions.read('applicant-home-address', params={'application_id': application_id}).record
