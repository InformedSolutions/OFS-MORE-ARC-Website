...
# def adult_update_add_previous_name(request):
#     """
...
#             if delete_id != '':
#                 response = HMGatewayActions().delete('previous-name',
...
#             log.debug("Handling submissions for Adult Update previous names page - add another name")
...
#
#         else:
#             log.debug("Handling submissions for Adult Update previous names page - save and continue")
#             return HttpResponseRedirect(build_url('new_adults_summary', get={'id': app_id}))
#
...
#     }
#     log.debug("Rendering Adult Update previous name page")
#     return render(request, 'adult_update_templates/adult-update-add-previous-names.html', context)
#
#
...
#     return HttpResponseRedirect(build_url(adult_update_add_previous_name, get=params))
#
#
...
#     response = HMGatewayActions().list('previous-name', params={'adult_id': application_id})
#     initial_data = []
#
...
#         HMGatewayActions().delete('previous-name', params={'previous_name_id': form.cleaned_data['previous_name_id']})
#         HMGatewayActions().create('previous-name', params={
#             'adult_id': application_id,
