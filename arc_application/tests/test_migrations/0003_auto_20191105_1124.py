# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-11-05 11:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('arc_application', '0002_adultinhome_pith_mobile_number'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='adult_id',
            field=models.ForeignKey(db_column='adult_id', on_delete=django.db.models.deletion.CASCADE, to='arc_application.AdultInHome'),
        ),
        migrations.AddField(
            model_name='adultinhomeaddress',
            name='application_id',
