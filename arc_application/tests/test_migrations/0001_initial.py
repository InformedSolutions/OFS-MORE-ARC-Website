# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-11-12 17:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_treatment', models.NullBooleanField(blank=True)),
                ('serious_illness', models.NullBooleanField(blank=True)),
                ('known_to_council', models.NullBooleanField(blank=True)),
                ('children_details', models.TextField(default='', null=True)),
                ('hospital_admission', models.NullBooleanField(blank=True)),
