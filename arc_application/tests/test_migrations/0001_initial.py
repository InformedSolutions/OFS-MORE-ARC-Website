# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-11-21 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PITH_mobile_number', models.CharField(blank=True, max_length=20)),
                ('PITH_same_address', models.NullBooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adult_id', models.ForeignKey(db_column='adult_id', on_delete=django.db.models.deletion.CASCADE, to='arc_application.AdultInHome')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adult_update_review', models.CharField(blank=True, choices=[('NOT_STARTED', 'NOT_STARTED'), ('FLAGGED', 'FLAGGED'), ('COMPLETED', 'COMPLETED')], default='NOT_STARTED', max_length=50, null=True)),
            ],
            options={
                'db_table': 'ARC',
            },
