...
urlpatterns = [
    ...
    url(r'^people/previous_names', add_previous_name, name='other-people-previous-names'),
    url(r'^people/previous_addresses', address_state_dispatcher, name='other-people-previous-addresses'),
